...
var student2 = new Student("Bob", 123, "2nd", ["Operating System", "Data Structure", "Algorithm"]);
...
for (var i = 0; i < students.length; i++) {
    var s = students[i];
    document.writeln('<br><span style="color:red;">Name: ' + s.name);
...
document.writeln('<span style="color:green;">'+text2[i].innerText+'</span><br>');
